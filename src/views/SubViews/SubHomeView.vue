               ...
               <form class="custom-border w-full max-w-[849px] md:block mx-auto md:relative" v-show="activeTab !== 5">
                    <div class="flex flex-row">
                         <div :class="{ '': showTrue, 'border-b-2 border-blue-700': !showTrue }"
                              class="mr-[5px] py-3 px-6 rounded-t-xl cursor-pointer" @click="showTrue = false">
                              <span class="text-black text-lg font-semibold font-['Plus Jakarta Sans'] leading-snug"
                                   :class="{ '': showTrue, ' text-blue-700': !showTrue }"> {{
                                        searchBar.SearchFerryTicket?.title }}</span>
                         </div>
                         <div :class="{ '': !showTrue, 'border-b-2 border-blue-700': showTrue }"
                              class="mr-4 py-3 px-9 rounded-t-xl text-white cursor-pointer" @click="showTrue = true">
                              <span class="text-center text-black text-lg font-semibold font-['Plus Jakarta Sans'] leading-snug"
                                   :class="{ '': !showTrue, 'text-blue-700': showTrue }"> {{
...
useHead({
     title: `Meander Travel | Ferry | Tour`,
     meta: [
