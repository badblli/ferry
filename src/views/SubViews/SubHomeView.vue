        ...
        <div class="w-full flex flex-col mx-24 centered-w justify-center items-center">
            <div class="flex flex-col">
                <div class="flex flex-row border-sub-line">
                    <div @click="activeTab = 'tab1'" class="tab mx-4 px-20 first:ml-20"
                        :class="{ active: activeTab === 'tab1' }">
                        Midilli Adası
                    </div>
                    <div @click="activeTab = 'tab2'" class="tab mx-4 px-4" :class="{ active: activeTab === 'tab2' }">
                        Feribot Seferleri
                    </div>
                    <div @click="activeTab = 'tab3'" class="tab mx-4 px-4" :class="{ active: activeTab === 'tab3' }">
                        Nasıl Gidilir
                    </div>
                    <div @click="activeTab = 'tab4'" class="tab mx-4 px-4" :class="{ active: activeTab === 'tab4' }">
                        Gezilecek Yerler
                    </div>
                    <div @click="activeTab = 'tab5'" class="tab mx-4 px-4" :class="{ active: activeTab === 'tab5' }">
                        Sıkça Sorular Sorular
                    </div>
                    <div @click="activeTab = 'tab6'" class="tab mx-4 px-20 mr-20 "
                ...
                <div>
                    ...
                    <div v-show="activeTab === 'tab3'" class="mt-[75px] mb-16">
                        ...
                        <div>
                            <div
                                class="text-center text-slate-800 text-5xl font-bold font-['Plus Jakarta Sans'] leading-[48px]">
                                Midilli Adasına Nasıl Gidilir?</div>
                        </div>
                    </div>
                    <div v-show="activeTab === 'tab4'" class="mt-[75px] mb-16">
                        ...
                        <div>
                            <div
                                class="text-center text-slate-800 text-5xl font-bold font-['Plus Jakarta Sans'] leading-[48px]">
                                Midilli Adası'nda Gezilecek Yerler</div>
                        </div>
                    </div>
                    ...
                    <form v-show="activeTab !== 'tab4' && activeTab !== 'tab6'"
                        ...
                        <div class="flex flex-row">
                            <div :class="{ '': showTrue, 'border-b-2 border-blue-700': !showTrue }"
                                ...
                                <span @click="showTrue = false"
                                    ...
                                    :class="{ '': showTrue, ' text-blue-700': !showTrue }">Search
                                    Ferry Title</span>
                            </div>
                            <div :class="{ '': !showTrue, 'border-b-2 border-blue-700': showTrue }"
                            ...
                            <div class="flex flex-row items-center w-full custom-border-top" v-show="!showTrue">
                                        ...
                                        <div class="flex flex-col w-[277px] p-5">
                                            <div class="flex flex-col">
                                                <div
                                                    ...
                                                    <a
                                                        class="text-black text-base font-medium font-display tracking-tight ">TownName</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="hs-dropdown-menu hidden transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 min-w-60 bg-white shadow-md rounded-lg mt-2 divide-y divide-gray-200 "
                                        ...
                                        <div class="flex flex-col w-[277px] p-5">
                                            <div
                                                class="flex flex-col hover:bg-slate-200 transition delay-[5ms] mb-5 pt-[7px] pl-[14px] pb-2 rounded-lg cursor-pointer">
                                                <a
                                                    class="text-black text-base font-medium font-display tracking-tight">Gidiş-Dönüş</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex flex-row items-center">
                                    <div class="cursor-pointer flex flex-col justify-start py-6 px-7">
                                        <span
                                            class="overflow-hidden whitespace-nowrap truncate text-black text-base font-medium font-display tracking-tight">Bilet
                                            Tipi</span>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div
                                        class="hidden min-w-60 bg-white w-[369px] shadow-md rounded-lg mt-2 divide-y divide-gray-200">
                                ...
                                <div
                                    class="w-28 h-[46px] bg-blue-600 rounded-[82px] text-white justify-center items-center flex flex-row">
                                    Bilet Ara</div>
                            </div>
                            <div v-show="showTrue">
                                <div class="w-[798px]">
                ...
                <div class="px-2 md:px-16 sm:px-8 centered-w" v-show="activeTab === 'tab1'">
                    <div class="md:mt-[73px] md:mb-32 mb-5 mt-5">
                        <div class="w-full text-black text-lg font-normal font-display leading-loose tracking-tight">
                            Yunan adalarının en çok tercih edilenleri arasında ilk sırada gelen Midilli'ye en rahat
                            ulaşım yolu; Ayvalık Midilli feribot seferleri olarak bilinmektedir. Nisan ve eylül ayları
                            arası olan dönem; yüksek sezon olarak geçmektedir. Bu dönemde, her gün Ayvalık Midilli
                            feribot seferleri düzenlenmektedir.<br /><br />Türklerin yaz aylarında özellikle tatil için
                            Yunan adalarına gitme sıklığı, son yıllarda artmaktadır. Bu artışta, Yunanistan'ın Yunan
                            adalarına kapıda vize uygulaması getirmesinin etkisi büyüktür. Kapı vizesi uygulaması
                            olduğundan dolayı ziyaretçi artışı gösteren Yunan Adaları'na Ege Denizi'nde yer alan ve
                            feribot kullanılarak gidilebilmektedir. Yunan adaları; son yılların en gözde tatil ve
                            ziyaret mekanları arasında yer almaktadır.</div>
                    </div>
                    <div>
                        <div class="text-black text-[32px] font-medium font-['Plus Jakarta Display'] tracking-wide">
                            Midilli Turu
                            Ayrıcalıkları</div>
                        <div class="text-black text-lg font-normal font-['Plus Jakarta Display'] tracking-tight">En son
                            aramalarınız
                        </div>
                ...
                <div class="px-2 md:px-16 sm:px-8 centered-w" v-show="activeTab === 'tab2'">
                    <div>
                        <div
                            ...
                            Midilli adasına en hızlı ve ekonomik şekilde Ayvalık’tan gidilebilmektedir. Ayvalık Midilli
                            feribot seferlerini gerçekleştiren Jalem Tur ve Turyol firmalarının feribotları vardır.
                            Turyol firmasına ait normal feribot ile 90 dakikada ve Jalem Tur firmasına ait olan hızlı
                            katamaran ile de seferler 45 dakika sürmektedir.<br /><br />Turyol ve Jalem Tur firmalarının
                            Ayvalık Midilli feribot sefer saati yaz ve kış dönemlerinde farklılıklar göstermektedir.
                            Ayvalık Midilli feribotlarının kalkış saati sabah 9.00’dur. Ramazan Bayramı ve Kurban
                            Bayramı dönemlerinde ek feribot seferleri düzenlenmektedir.</div>
                                ...
                                <div class="mx-12">
                                    <div class="flex flex-row  items-center mt-3">
                                        ...
                                        <div
                                            ...
                                            Alttaki Samos’a feribot bileti ücretlerine Kuşadası ve Samos liman vergileri
                                            dahildir.</div>
                                    </div>
                                    <div class="flex flex-row  items-center mt-3">
                                        <IconAsteriskSimple />
                                        <div
                                            ...
                                            Samos adasına seyahatiniz için gerekli olan en az altı ay geçerli bir
                                            pasaport ve Schengen vizesi olup vize konusunda dilerseniz firmamız sizlere
                                            yardımcı olmaktan mutluluk duyacaktır.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="px-2 md:px-16 sm:px-8 centered-w" v-show="activeTab === 'tab3'">
                    <div>
                        <div
                            ...
                            Ayvalık Midilli feribot seferleri tüm yıl boyunca devam etmekte, yaz aylarında ise her gün
                            yapılan seferler karşılıklı olarak düzenlenmektedir. Sabah 09:00 – 18:00 saatleri arasında
                            yapılan feribot seferleri dönemsel olarak yoğunluğa göre ek seferlerle de güncellenmektedir.
                            Seyahat öncesinde feribot saatlerinin kontrol edilmesi gerekmektedir. Ayvalık – Midilli
                            feribot yolculuğu ortalama 1 saat sürmektedir.<br /><br />Bilindiği üzere Türkiye’den
                            Midilli Adasına ziyaret için Balıkesir’in Ayvalık ilçesinde bulunan iskele kullanılmaktadır.
                            Aynı zamanda Midilli Adası ziyaretleri için Yunanistan feribotları da kullanılabilir.
                            Midilli ziyaretinizi Sakız adası ile birleştirmek istediğinizde ise yine feribot ulaşımını
                            tercih edebilirsiniz.<br />Ayvalık’tan Midilliye gitmek için öncelikle ofislerden veya
                            online olarak bilet satın alınmalıdır.</div>
                    </div>
                                        ...
                                        <div class=" bg-white p-4 rounded-[20px] card-border flex flex-row">
                                            ...
                                            <div class="w-full">
                                                ...
                                                <div
                                                    ...
                                                    Feribot, liman vergisi, oda-kahvaltı konaklama içermektedir.</div>
...
const accordions = ref([
    {
        title: 'Samos a turlar ne zaman başlar', body: 'Sabah 07:30’da Kuşadası Meander Travel ofisinde check-in ve pasaport işlemlerinizin ardından saat 09:00’da Samos’a hareket ediyor ve 10:15de varıyorsunuz.Vaktinizi adanın güzel köşelerini keşfederek geçirebilirsiniz.', active: true
    },
    {
        title: 'Vize işlemlerinde yapılması gerekenler nelerdir?', body: 'Sabah 07:30’da Kuşadası Meander Travel ofisinde check-in ve pasaport işlemlerinizin ardından saat 09:00’da Samos’a hareket ediyor ve 10:15de varıyorsunuz.Vaktinizi adanın güzel köşelerini keşfederek geçirebilirsiniz.', active: true
    },
    {
        title: 'Bilet almadan önce sizinle iletişim kurabilir miyim?', body: 'Sabah 07:30’da Kuşadası Meander Travel ofisinde check-in ve pasaport işlemlerinizin ardından saat 09:00’da Samos’a hareket ediyor ve 10:15de varıyorsunuz.Vaktinizi adanın güzel köşelerini keşfederek geçirebilirsiniz.', active: true
    },
    {
        title: 'Sadece Samos adasına mı bilet alabiliyorum?', body: 'Sabah 07:30’da Kuşadası Meander Travel ofisinde check-in ve pasaport işlemlerinizin ardından saat 09:00’da Samos’a hareket ediyor ve 10:15de varıyorsunuz.Vaktinizi adanın güzel köşelerini keşfederek geçirebilirsiniz.', active: true
    },
]);
