          ...
          <div class="relative top-[-11rem] w-full lg:px-[100px] px-2 md:px-16 sm:px-8 centered-w">
               <div class="flex flex-row justify-between items-center mb-9">
                    <div class="flex flex-row justify-center items-center">
                         ...
                         <div class="w-[52px] h-[52px] opacity-75 bg-white rounded-full flex justify-center items-center mx-[33px] p-4">
                    ...
                    <div class="flex flex-row items-center justify-end w-full">
                         <div class="bg-white rounded-lg border flex justify-center items-center cursor-pointer px-5 py-1">
