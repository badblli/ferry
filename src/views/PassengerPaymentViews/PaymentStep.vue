                         ...
                         <div class="flex flex-col md:flex-row gap-5">
                              <div class="lg:w-3/5 w-full">
                                   ...
                                   <div v-else class="hs-accordion-group">
                                        <div class="hs-accordion active items-centers rounded-xl bg-white mb-4 last:mb-[46px]" id="hs-basic-heading-one">
                                             <button class="hs-accordion-toggle inline-flex flex-row justify-between w-full font-semibold text-xl font-['Plus Jakarta Sans'] leading-[38px] text-black disabled:opacity-50 disabled:pointer-events-none" aria-controls="hs-basic-collapse-one">
                                                  <div class="flex flex-row items-center justify-between w-full">
                                                       <div class="flex flex-row items-center">
                                                            <div class="text-black text-lg font-semibold font-['Plus Jakarta Sans'] ml-[40px] py-[35px]">{{ paymentDetail?.InvoiceTabTopTitle }}</div>
                                                       </div>
                                             ...
                                             <div id="hs-basic-collapse-one" class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300" aria-labelledby="hs-basic-heading-one">
                                                  <div class="flex flex-col">
                                                       <nav class="mt-2 flex overflow-x-auto [&::-webkit-scrollbar]:h-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300" aria-label="Tabs" role="tablist">
                                                            <button
                                                                 type="button"
                                                                 ...
                                                                 role="tab"
                                                            >
                                                                 <div class="mx-[46px]">{{ paymentDetail?.InvoiceTab[0].tabTitle }}</div>
                                                            </button>
                                                            <button type="button" class="hs-tab-active:font-medium hs-tab-active:border-blue-700 hs-tab-active:text-blue-700 pb-[23px] px-1 border-b border-transparent whitespace-nowrap text-neutral-400 hover:text-blue-600 focus:outline-none focus:text-blue-600 disabled:opacity-50 disabled:pointer-events-none" id="horizontal-scroll-tab-item-2" data-hs-tab="#horizontal-scroll-tab-2" aria-controls="horizontal-scroll-tab-2" role="tab">
                                                                 <div class="mx-[46px]">{{ paymentDetail?.InvoiceTab[1].tabTitle }}</div>
                                                            </button>
                                        ...
                                        <div class="hs-accordion items-centers rounded-xl bg-white mb-4 last:mb-[46px]" id="hs-basic-heading-two">
                                             <button class="hs-accordion-toggle hs-accordion-active:text-blue-600 inline-flex items-center gap-x-3 w-full font-semibold text-start text-gray-800 hover:text-gray-500 rounded-lg disabled:opacity-50 disabled:pointer-events-none dark:hs-accordion-active:text-blue-500 dark:text-gray-200 dark:hover:text-gray-400 dark:focus:outline-none dark:focus:text-gray-400" aria-controls="hs-basic-collapse-two">
                                                  <div class="flex flex-row items-center justify-between w-full">
                                                       <div class="flex flex-row items-center">
                                                            <div class="text-black text-lg font-semibold font-['Plus Jakarta Sans'] ml-[40px] py-[35px]">{{ paymentDetail?.PaymentTopTitle }}</div>
                                                       </div>
                                                       <div class="flex flex-row">
                                                            <div class="items-center flex pl-1 mr-6">
                                                                 <IconAccordionActiveArrow class="hs-accordion-active:block hidden" />
                                                  ...
                                                  <div class="flex flex-col">
                                                       <nav class="mt-2 flex overflow-x-auto [&::-webkit-scrollbar]:h-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300" aria-label="Tabs" role="tablist">
                                                            <button
                                                                 ...
                                                                 role="tab"
                                                            >
                                                                 <div class="mx-[46px]">{{ paymentDetail?.PaymentTab[0].tabTitle }}</div>
                                                            </button>
                                                       </nav>
                              ...
                              <div class="lg:w-2/5 w-full rounded-[20px]">
                                   <div>
                                        <div v-for="(item, index) in fakeData" :key="index" class="bg-white p-[30px] rounded-[20px]">
                                             <h2 class="text-black text-2xl font-semibold font-['Plus Jakarta Sans'] tracking-wide mt-[10px] mb-[31px] ml-[10px]">{{ paymentDetail?.PaymentSummary.title }}</h2>
                                             ...
                                             <div class="rounded-xl border border-zinc-300">
                                                  ...
                                                  <div else>
                                                       <div class="flex flex-col justify-between px-[30px] pt-[27px] pb-[13px]">
                                                            ...
                                                            <div v-if="newData.Departure?.AdultSummary !== null" class="flex flex-row justify-between mb-[31px] mt-10">
                                                                 <p class="text-neutral-700 text-base font-normal font-['Plus Jakarta Sans']">{{ paymentDetail?.PaymentSummary.adultPassenger }}</p>
                                                            ...
                                                            <div v-if="newData.Departure?.ChildSummary !== null" class="flex flex-row justify-between mb-[31px]">
                                                                 <p class="text-neutral-700 text-base font-normal font-['Plus Jakarta Sans']">{{ paymentDetail?.PaymentSummary.childPassenger }}</p>
                                                                 <p class="text-right text-black text-base font-semibold font-['Plus Jakarta Sans']">
                                                                      {{ newData.Departure?.ChildSummary }}
                                                                 </p>
                                                            </div>
                                                            <div v-if="newData.Departure?.InfantSummary !== null" class="flex flex-row justify-between mb-[41px]">
                                                                 <p class="text-neutral-700 text-base font-normal font-['Plus Jakarta Sans']">{{ paymentDetail?.PaymentSummary.babyPassenger }}</p>
                                                                 <p class="text-right text-black text-base font-semibold font-['Plus Jakarta Sans']">
                                                       ...
                                                       <div class="flex flex-col justify-between px-[30px] pt-[31px] pb-10">
                                                            <div class="flex flex-row justify-between">
                                                                 <div class="text-black text-lg font-semibold font-['Plus Jakarta Sans']">{{ paymentDetail?.PaymentSummary.passengerInformation }}</div>
                                                                 <div>
                                                                      <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                           <path
                                                                                fill-rule="evenodd"
                                                            ...
                                                            <div class="flex flex-row justify-between mb-[31px] mt-10">
                                                                 <p class="text-neutral-700 text-base font-normal font-['Plus Jakarta Sans']">{{ paymentDetail?.PaymentSummary.departureDate }}</p>
                                                                 <p class="text-right text-black text-base font-semibold font-['Plus Jakarta Sans']">
                                                                      {{ formatDate(newData.Departure?.DepartureDate) }}
                                                                 </p>
                                                            </div>
                                                            <div class="flex flex-row justify-between mb-[31px]">
                                                                 <p class="text-neutral-700 text-base font-normal font-['Plus Jakarta Sans']">{{ paymentDetail?.PaymentSummary.destinationDate }}</p>
                                                                 <p class="text-right text-black text-base font-semibold font-['Plus Jakarta Sans']">
                                                                      {{ formatDate(newData.Return?.DepartureDate) }}
                                                                 </p>
                                                            </div>
                                                            <div class="flex flex-row justify-between mb-[41px]">
                                                                 <p class="text-neutral-700 text-base font-normal font-['Plus Jakarta Sans']">{{ paymentDetail?.PaymentSummary.departurePort }}</p>
                                                                 <p class="text-right text-black text-base font-semibold font-['Plus Jakarta Sans']">
                                                                      {{ departureDataRef }}
                                                                 </p>
                                                            </div>
                                                            <div class="flex flex-row justify-between mb-[41px]">
                                                                 <p class="text-neutral-700 text-base font-normal font-['Plus Jakarta Sans']">{{ paymentDetail?.PaymentSummary.destinationPort }}</p>
                                                                 <p class="text-right text-black text-base font-semibold font-['Plus Jakarta Sans']">
                                                                      {{ returnDataRef }}
                                                                 </p>
                                                            </div>
                                                  ...
                                                  <div v-if="!paymentSuccess" class="flex flex-row items-center justify-between px-[30px] py-9">
                                                       <div class="text-black text-lg font-semibold font-['Plus Jakarta Sans']">{{ paymentDetail?.PaymentSummary.EarnedMilePoints }}</div>
                                             ...
                                             <div v-if="!paymentSuccess" class="w-full flex flex-row items-center justify-between px-[30px] bg-slate-200 mt-[10px] rounded-2xl">
                                                  ...
                                                  <div>
                                                       <div class="px-5 py-2 my-5 bg-white rounded-lg border text-center text-black text-base font-medium font-display cursor-pointer">{{ paymentDetail?.PaymentSummary.useIt }}</div>
                                                  </div>
                                             </div>
                                             <div v-if="paymentSuccess" class="flex flex-row mt-[41px] mb-4">
                                                  ...
                                                  <div class="flex flex-col ml-[19px]">
                                                       <div class="text-black text-base font-semibold font-['Plus Jakarta Sans']">{{ paymentDetail?.PaymentSummary.cancelAndRefund }}</div>
                                                       <div class="w-full text-neutral-700 text-sm font-normal font-['Plus Jakarta Sans'] leading-snug tracking-tight">{{ paymentDetail?.PaymentSummary.payDescription }}</div>
                                                  </div>
                                             </div>
                                             <div v-if="!paymentSuccess" class="flex flex-row items-center justify-between mt-8 mb-[5px]">
                                                  <div class="text-neutral-700 text-lg font-normal font-['Plus Jakarta Sans']">{{ paymentDetail?.PaymentSummary.totalPayment }}</div>
                                                  <div class="flex flex-col">
