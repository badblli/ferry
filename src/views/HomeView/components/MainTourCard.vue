    ...
    <section class="lg:px-[100px] px-16 md:px-16 sm:px-8 centered-w">
        ...
        <div class="w-full flex flex-row justify-between items-center mt-[37px]">
            <div
                ...
                Eşsiz tarihi Yunan
                mimarisi, görülmeye değer mekanlar.</div>
        ...
        <div class="flex flex-col md:flex-row gap-5 md:mb-[120px] mb-20">
            <!-- sections -->
            <div
                class="w-[400px] h-[510px] rounded-xl border border-gray-200 mt-12 hover:bg-slate-100 transition delay-[10ms] cursor-pointer">
