               ...
               <div
                    ...
                    <div class="ml-[46px]">
                         <div>
                              ...
                              <input :disabled="!person.editing" v-model="person.value"
                    ...
                    <div
                         ...
                         <button class="text-center text-black text-base font-bold font-text leading-normal"
                              @click="person.editing ? saveEdit(index) : (editField(index), formatBirthDateInput(index))">
...
const people = ref([
     ...
     { title: 'Doğum Tarihi', value: computed(() => formatBirthDate(userInfo.value ? userInfo.value.BirthDate : '')), editing: false },
