<template>
     ...
     <div v-if="!isLoading">
          <div
               class="w-full lg:px-[100px] px-16 md:px-16 sm:px-8 h-[172px] bg-slate-200 flex justify-evenly items-center grid-cols-4">
               ...
               <div
                    ...
                    <div>
                         <div class="text-lg font-bold mb-4 flex">
                              <IconMainSamosa />
                              <div>
                                   <span className="text-black text-2xl font-bold font-display tracking-wide">{{
          mainFooter.footerBrand?.title }}</span>
                              </div>
                         </div>
                         <ul>
                              <li>
