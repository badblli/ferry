<template>
     <div>
          ...
          <transition enter-active-class="transition-opacity duration-200" leave-active-class="transition-opacity duration-200" enter-class="opacity-0" leave-class="opacity-100">
               <div v-if="hasContent" class="fixed flex items-center justify-center z-50 inset-0 overflow-y-auto">
                    <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block">
                         ...
                         <div @click.self="closeModal" class="inline-block align-middle bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg sm:w-full flex">
                              <!-- Left Part: Image -->
                              <div class="w-1/2">
