<template>
    <!-- Datepicker -->
    <div
        class="w-80 md:w-[40.4rem] flex flex-col bg-white border shadow-lg rounded-xl overflow-hidden dark:bg-slate-900 dark:border-gray-700">
        <div class="p-3 grid md:flex gap-8">
            ...
            <div class="space-y-0.5">
                ...
                "optionTemplate": "<div class=\"flex justify-between items-center w-full\"><span data-title></span><span class=\"hidden hs-selected:block\"><svg class=\"flex-shrink-0 w-3.5 h-3.5 text-gray-800 dark:text-gray-200\" xmlns=\"http:.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><polyline points=\"20 6 9 17 4 12\"/></svg></span></div>"
                    ...
                    <div class="col-span-1 flex justify-end">
                        <button type="button"
                            class="opacity-0 w-8 h-8 flex justify-center items-center text-gray-800 hover:bg-gray-100 rounded-full disabled:opacity-50 disabled:pointer-events-none dark:text-gray-400 dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                            <svg class="flex-shrink-0 w-4 h-4" width="24" height="24" viewBox="0 0 24 24" fill="none"
                ...
                <div class="flex">
                    ...
                    <div class="bg-gray-100 rounded-s-full dark:bg-gray-800">
                        <button type="button"
                            class="m-px w-10 h-10 flex justify-center items-center bg-blue-600 border border-transparent text-sm font-medium text-white hover:border-blue-600 rounded-full dark:bg-blue-500 disabled:text-gray-300 disabled:pointer-events-none dark:hover:border-gray-700">
                            20
                        </button>
                    </div>
                    <div class="bg-gray-100 first:rounded-s-full last:rounded-e-full dark:bg-gray-800">
                        <button type="button"
                            class="m-px w-10 h-10 flex justify-center items-center border border-transparent text-sm text-gray-800 hover:border-blue-600 hover:text-blue-600 rounded-full disabled:text-gray-300 disabled:pointer-events-none dark:text-gray-200 dark:hover:border-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 dark:disabled:text-gray-600">
                            21
                        </button>
                ...
                <div class="flex">
                    ...
                    <div class="bg-gradient-to-r from-gray-100 dark:from-gray-800">
                        <button type="button"
                            class="m-px w-10 h-10 flex justify-center items-center border border-transparent text-sm text-gray-800 hover:border-blue-600 hover:text-blue-600 rounded-full disabled:text-gray-300 disabled:pointer-events-none dark:text-gray-200 dark:hover:border-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 dark:disabled:text-gray-600"
                            disabled>
                            1
            ...
            <div class="space-y-0.5">
                ...
                <!-- Days -->
                <div class="flex">
                    <div class="bg-gradient-to-l from-gray-100 dark:from-gray-800">
                        <button type="button"
                            class="m-px w-10 h-10 flex justify-center items-center border border-transparent text-sm text-gray-800 hover:border-blue-600 hover:text-blue-600 rounded-full disabled:text-gray-300 disabled:pointer-events-none dark:text-gray-200 dark:hover:border-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 dark:disabled:text-gray-600"
                            disabled>
                            31
                ...
                <div class="flex">
                    ...
                    <div class="bg-gray-100 rounded-e-full dark:bg-gray-800">
                        <button type="button"
                            class="m-px w-10 h-10 flex justify-center items-center bg-blue-600 border border-transparent text-sm font-medium text-white hover:border-blue-600 rounded-full dark:bg-blue-500 disabled:text-gray-300 disabled:pointer-events-none dark:hover:border-gray-700">
                            10
                        </button>
