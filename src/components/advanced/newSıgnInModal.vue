<template>
     <div>
          <div
               class="fixed inset-0 flex flex-col items-center justify-start z-50 bg-white w-[638px] h-[732px] m-auto overflow-y-hidden rounded-3xl">
               <div class="flex flex-row items-center justify-center mt-10 w-full">
                    <div class=" w-full flex flex-row justify-center">
                         <div class="text-black  text-xl font-semibold font-['Plus Jakarta Sans'] ml-20">
                              Kullanıcı Kaydı
                         </div>
                    </div>
                    <div class="mr-5 cursor-pointer" @click="closeModal">
                         <div
                              class="w-[65px] h-[65px] bg-neutral-100 rounded-full flex flex-row justify-center items-center">
                              <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 34 34"
                                   fill="none">
                                   <g id="vuesax/outline/add">
                                        <g id="add">
                                             <path id="Vector"
                                                  d="M20.7128 21.7726L12.2275 13.2873C11.9376 12.9974 11.9376 12.5165 12.2275 12.2266C12.5174 11.9367 12.9982 11.9367 13.2881 12.2266L21.7734 20.7119C22.0633 21.0018 22.0633 21.4826 21.7734 21.7726C21.4835 22.0625 21.0027 22.0625 20.7128 21.7726Z"
                                                  fill="#2B2B33" />
                                             <path id="Vector_2"
                                                  d="M12.2266 21.7726C11.9367 21.4826 11.9367 21.0018 12.2266 20.7119L20.7119 12.2266C21.0018 11.9367 21.4826 11.9367 21.7725 12.2266C22.0624 12.5165 22.0624 12.9974 21.7725 13.2873L13.2872 21.7726C12.9973 22.0625 12.5165 22.0625 12.2266 21.7726Z"
                                                  fill="#2B2B33" />
                                        </g>
                                   </g>
                              </svg>
                    ...
                    <form class="flex justify-center items-center">
                         <div class="grid gap-y-4 my-auto justify-between items-center">
                              ...
                              <div>
                                   <div class="relative">
                                        <div class="flex items-center border-b border-gray-200">
                                             ...
                                             <span class="flex-shrink-0 bg-white text-sm text-white flex justify-center items-center w-[50px] h-[50px] rounded-full"
                                                  type="button">
                                             </span>
                                        </div>
                              ...
                              <button type="submit"
                                   ...
                                   <div class="text-center text-white text-base font-bold font-text leading-normal">
                                        Üye Ol ve Başla
                                   </div>
                              </button>
                         </div>
               ...
               <div class="w-[368px] text-center mb-[38px]"><span
                         class="text-slate-500 text-sm font-normal font-['Plus Jakarta Sans'] leading-snug">Hesap
                         oluşturmak, </span><span
                         class="text-black text-sm font-medium font-['Plus Jakarta Sans'] leading-snug">Hizmet
