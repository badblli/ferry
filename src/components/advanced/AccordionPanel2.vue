...
const props = defineProps({
     ...
     invoiceAccordionState: { type: Boolean, required: false },
     creditCardAccordionState: { type: Boolean, required: false },
     initialState: { type: Boolean, required: false, default: true }
})

const showPanel = ref(props.initialState)

const togglePanel = () => {
     showPanel.value = !showPanel.value
}

const invoiceAccordionStateRef = toRef(props, 'invoiceAccordionState')
const creditCardAccordionStateRef = toRef(props, 'creditCardAccordionState')

watch(creditCardAccordionStateRef, (newValue, oldValue) => {
     showPanel.value = newValue
})

watch(invoiceAccordionStateRef, (newValue, oldValue) => {
     showPanel.value = newValue
})
</script>
